namespace Sdk4me.GraphQL
{
    ...
    public class ServiceOffering : Node
    {
        ...
        /// <summary>
        /// The effort class that is selected by default, when someone registers time on a request with an active affected service level agreement based on the service offering.
        /// </summary>
        ...
        /// <summary>
        /// The number of business days within which a request with the impact value "High - Service Degraded for Several Users" is to be resolved when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        ...
        /// <summary>
        /// The number of business days within which a request with the impact value "Low - Service Degraded for One User" is to be resolved when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        ...
        /// <summary>
        /// The number of business days within which a request with the impact value "Medium - Service Down for One User" is to be resolved when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        ...
        /// <summary>
        /// The number of business days within which a request with the category "RFC - Request for Change" is to be resolved when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        ...
        /// <summary>
        /// The number of business days within which a request with the category "RFI - Request for Information" is to be resolved when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        ...
        /// <summary>
        /// The number of business days within which a request with the impact value "Top - Service Down for Several Users" is to be resolved when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        ...
        /// <summary>
        /// The number of business days within which a response needs to have been provided for a request with the impact "High - Service Degraded for Several Users" when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        ...
        /// <summary>
        /// The number of business days within which a response needs to have been provided for a request with the impact "Low - Service Degraded for One User" when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        ...
        /// <summary>
        /// The number of business days within which a response needs to have been provided for a request with the impact "Medium - Service Down for One User" when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        ...
        /// <summary>
        /// The number of business days within which a response needs to have been provided for a request with the category "RFC - Request for Change" when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        ...
        /// <summary>
        /// The number of business days within which a response needs to have been provided for a request with the category "RFI - Request for Information" when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        ...
        /// <summary>
        /// The number of business days within which a response needs to have been provided for a request with the impact "Top - Service Down for Several Users" when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        ...
        /// <summary>
        /// The service level agreement notification scheme for a request with the impact "High - Service Degraded for Several Users" when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        [JsonProperty("slaNotificationSchemeHigh")]
        public SlaNotificationScheme? SlaNotificationSchemeHigh { get; internal set; }

        /// <summary>
        /// The service level agreement notification scheme for a request with the impact "Low - Service Degraded for One User" when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        [JsonProperty("slaNotificationSchemeLow")]
        public SlaNotificationScheme? SlaNotificationSchemeLow { get; internal set; }

        /// <summary>
        /// The service level agreement notification scheme for a request with the impact "Medium - Service Down for One User" when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        [JsonProperty("slaNotificationSchemeMedium")]
        public SlaNotificationScheme? SlaNotificationSchemeMedium { get; internal set; }

        /// <summary>
        /// The service level agreement notification scheme for a request with the impact "Top - Service Down for Several Users" when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        ...
        /// <summary>
        /// The calendar that defines the support hours for a request with the impact "High - Service Degraded for Several Users" when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        [JsonProperty("supportHoursHigh")]
        public Calendar? SupportHoursHigh { get; internal set; }

        /// <summary>
        /// The calendar that defines the support hours for a request with the impact "Low - Service Degraded for One User" when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        [JsonProperty("supportHoursLow")]
        public Calendar? SupportHoursLow { get; internal set; }

        /// <summary>
        /// The calendar that defines the support hours for a request with the impact "Medium - Service Down for One User" when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        [JsonProperty("supportHoursMedium")]
        public Calendar? SupportHoursMedium { get; internal set; }

        /// <summary>
        /// The calendar that defines the support hours for a request with the category "RFC - Request for Change" when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        [JsonProperty("supportHoursRfc")]
        public Calendar? SupportHoursRfc { get; internal set; }

        /// <summary>
        /// The calendar that defines the support hours for a request with the category "RFI - Request for Information" when it affects an active service level agreement that is based on the service offering.
        /// </summary>
        [JsonProperty("supportHoursRfi")]
        public Calendar? SupportHoursRfi { get; internal set; }

        /// <summary>
        /// The calendar that defines the support hours for a request with the impact "Top - Service Down for Several Users" when it affects an active service level agreement that is based on the service offering.
        /// </summary>
