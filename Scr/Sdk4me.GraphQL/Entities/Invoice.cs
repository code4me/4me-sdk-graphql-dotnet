...
namespace Sdk4me.GraphQL
{
    ...
    public class Invoice : Node
    {
        ...
        /// </summary>
        [JsonProperty("invoiceDate"), Sdk4meField(IsDefaultQueryProperty = true)]
#if NET6_0_OR_GREATER
        ...
        /// </summary>
        [JsonProperty("invoiceNr"), Sdk4meField(IsDefaultQueryProperty = true)]
        public string? InvoiceNr { get; internal set; }

        /// <summary>
        /// The number of the purchase order that was sent to supplier.
        /// </summary>
        [JsonProperty("poNr"), Sdk4meField(IsDefaultQueryProperty = true)]
