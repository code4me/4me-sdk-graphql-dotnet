...
namespace Sdk4me.GraphQL
{
    ...
    public class SurveyResponse : Node
    {
        ...
        /// </summary>
        [JsonProperty("rating"), Sdk4meField(IsDefaultQueryProperty = true)]
        public string? Rating { get; internal set; }

        /// <summary>
        /// How the individual answers were combined to calculate the rating.
        /// </summary>
        [JsonProperty("ratingCalculation"), Sdk4meField(IsDefaultQueryProperty = true)]
        ...
        /// </summary>
        [JsonProperty("survey"), Sdk4meField(IsDefaultQueryProperty = true)]
