...
{
    /// <summary>
    /// The <see href="https://developer.4me.com/graphql/input_object/requestcreateinput/">RequestCreateInput</see> object.
    /// </summary>
    public class RequestCreateInput : PropertyChangeSet
    {
        ...
        /// <summary>
        /// Used to specify the support domain account identifier in which the request is to be registered. This parameter needs to be specified when the current user's Person record is registered in a directory account. The identifier of a 4me account can be found in the 'Account Overview' section of the Settings console.
        /// </summary>
